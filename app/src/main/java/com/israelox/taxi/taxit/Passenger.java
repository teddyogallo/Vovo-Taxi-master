...
public class Passenger extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        display_nam=findViewById(R.id.username);
        display_name=display_nam.toString();
                        ...
                        mDatabase.setValue(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                if(task.isSuccessful()){
                                    ...
                                    Intent mainIntent = new Intent(getApplicationContext(), CustomerMapActivity.class);
            ...
            public void onClick(View v) {
                ...
                if (fabbutton.getTag().equals(getResources().getString(R.string.tag_verify))) {
                    ...
                    if (mVerified) {
                        ...
                        startActivity(new Intent(Passenger.this, CustomerMapActivity.class));
                    }
